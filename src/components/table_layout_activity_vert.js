    ...
    <table className="table w-full table-auto border-collapse border-slate-500">
        <thead>
            <tr>
                ...
                <th className="chartText border-b border-slate-600 px-4 py-2 text-slate-800">FLOOR</th>
                <th className="chartText border-b border-slate-600 px-4 py-2 text-slate-800">1 DAY CHANGE</th>
            </tr>
        </thead>
        <tbody>
